        ...
        <div class="topbar <?php echo esc_attr($kyma_theme_options['topbarcolor']); ?>">
            ...
            <div class="content clearfix">
                ...
                <?php } if ($kyma_theme_options['social_media_header']) { ?>
					...
					if ($kyma_theme_options['social_linkedin_link'] != '') {
                        ?>
                    <a href="<?php echo esc_url($kyma_theme_options['social_linkedin_link']); ?>" target="_blank">
                        <span class="soc_name"><?php _e('Linkedin', 'kyma'); ?></span>
                        <span class="soc_icon_bg"></span>
